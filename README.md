...
6. Copy all partitions inside `s3://kalbe-workshop-test-ADMINACCOUNTID-use1/data/sales_consolidate_new/` to your bucket folder:  `s3:/[BUCKETNAME]/data/raw/sales_consolidate/` by running this command in CloudShell. Adjust the `BUCKET-NAME` based as needed.

     ```
     aws s3 cp s3://kalbe-workshop-test-ADMINACCOUNTID-use1/data/sales_consolidate_new/ s3://[BUCKET-NAME]/data/raw/sales_consolidate/ --acl bucket-owner-full-control --region us-east-1 --recursive
     ```
